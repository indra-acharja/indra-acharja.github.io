...
::: {style="display: flex; gap: 1.2rem; margin: 2rem 0; align-items: flex-start;"}
::: {style="flex: 1; min-width: 0;"}
![*A Sultan Tit (*Melanochlora sultanea*) in a riverside forest along the WBH survey corridor. Bhutan. © Indra Acharja/RSPN*](p2_sultan_tit.jpg)
:::
::: {style="flex: 1; min-width: 0;"}
![*A Scarlet Finch (*Haematospiza sipahi*) sheltering from the monsoon rain in a riverside forest — one of hundreds of bird species documented incidentally during WBH surveys. Bhutan. © Indra Acharja/RSPN*](p1_scarlet_finch.jpg)
:::
:::
